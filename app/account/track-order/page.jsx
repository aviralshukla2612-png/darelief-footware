    ...
    <AccountLayout>
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="bg-[#FAF7F2]/80 border border-[#E5DED4] rounded-3xl p-6 sm:p-10 shadow-xs relative overflow-hidden space-y-8">
          ...
          {/* Stepper Timeline: Responsive Horizontal Desktop / Vertical Mobile */}
          <div className="relative">
            {/* Desktop Connective Dotted Curve Line */}
            <div className="hidden lg:block absolute top-[58px] left-[6%] right-[6%] h-[2px] z-0 pointer-events-none">
            ...
            {/* Stepper Nodes Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6 lg:gap-3 relative z-10">
